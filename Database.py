...
airports_df = pd.read_excel("Dataset/filtered_airports.xlsx")
routes_df = pd.read_excel("Dataset/filtered_routes.xlsx")
airlines_df = pd.read_excel("Dataset/filtered_airlines.xlsx")
airplanes_df = pd.read_excel("Dataset/filtered_airplanes.xlsx")
...
def add_travellers(user_id, travellers_list):
    ...
    cur.close()
    conn.close()
    print(f"{len(travellers_list)} travellers added for user_id {user_id}.")
